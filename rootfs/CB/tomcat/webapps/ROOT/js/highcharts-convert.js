	...
	var config = {
			...
			files: {
				highcharts: {
					...
					HIGHCHARTS_MORE: 'highcharts/highcharts-more.js',
					HIGHCHARTS_DATA: 'highcharts/modules/data.js',
					HIGHCHARTS_DRILLDOWN: 'highcharts/modules/drilldown.js',
					HIGHCHARTS_FUNNEL: 'highcharts/modules/funnel.js',
					HIGHCHARTS_HEATMAP: 'highcharts/modules/heatmap.js',
					HIGHCHARTS_TREEMAP: 'highcharts/modules/treemap.js',
					HIGHCHARTS_3D: 'highcharts/highcharts-3d.js',
					HIGHCHARTS_NODATA: 'highcharts/modules/no-data-to-display.js',
					// Uncomment below if you have both Highcharts and Highmaps license
					// HIGHCHARTS_MAP: 'map.js',
					HIGHCHARTS_SOLID_GAUGE: 'highcharts/modules/solid-gauge.js',
					BROKEN_AXIS: 'highcharts/modules/broken-axis.js'
				}
			},
