...
(function (factory) {
  ...
  $.FE.PLUGINS.emoticons = function (editor) {
    ...
    function _emoticonsHTML () {
      ...
      if (editor.opts.emoticonsUseImage) emoticons_html += '<p style="font-size: 12px; text-align: center; padding: 0 5px;">Emoji free by <a class="fr-link" tabIndex="-1" href="http://emojione.com/" target="_blank" rel="nofollow noopener noreferrer" role="link" aria-label="Open Emoji One website.">Emoji One</a></p>';
      emoticons_html += '</div>';
