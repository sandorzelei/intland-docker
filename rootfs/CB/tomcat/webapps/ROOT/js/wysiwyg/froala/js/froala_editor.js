  ...
  $.FE.MODULES.spaces = function (editor) {
    ...
    function _normalizeNode (node, browser_way) {
      ...
      if (browser_way) {
        ...
        if (txt === ' ' && ((p_node && editor.node.isVoid(p_node)) || (n_node && editor.node.isVoid(n_node))) && !(p_node && n_node && editor.node.isVoid(p_node) && editor.node.isVoid(n_node))) {
          txt = '';
        }
      }
      ...
      for (var t = 0; t < txt.length; t++) {
        if (txt.charCodeAt(t) == 32 && (t === 0 || new_text.charCodeAt(t - 1) == 32) && !(p_node && n_node && editor.node.isVoid(p_node) && editor.node.isVoid(n_node))) {
    ...
    function _processNodeFormat (start_node, tag, attrs) {
      ...
      if (!node) {
        ...
        if (p_node) {
          ...
          // issue https://github.com/froala/wysiwyg-editor/issues/2886
          while (sibling.tagName === 'BR') {
            sibling = sibling.nextSibling;
          }
