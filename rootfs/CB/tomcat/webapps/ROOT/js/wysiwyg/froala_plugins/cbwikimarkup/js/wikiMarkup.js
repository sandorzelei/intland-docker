...
(function (factory) {
  ...
  $.FE.PLUGINS.wikiMarkup = function (editor) {
	    ...
	    function getBody(style) {
	    	...
	    	url = contextPath + "/js/wysiwyg/froala_plugins/cbwikimarkup/wikiMarkup.jsp";
	    	if (style) {
	    		url += "?style=" + style;
	    	}

	    	return "<iframe class=\"small\" src=\"" + url + "\" data-editor-id=\"" + editorId + "\" data-modal-id=\"" + modalId + "\"></iframe>";
	    }
