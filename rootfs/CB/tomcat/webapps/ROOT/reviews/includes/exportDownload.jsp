...
<ui:actionMenuBar>
  <ui:pageTitle><spring:message code="review.${review.mergeRequest ? 'merge.' : '' }export.title" /></ui:pageTitle>
</ui:actionMenuBar>
...
<script type="text/javascript">
  $(function() {
      ...
      if (window.parent.ajaxBusyIndicator.dialog) {
      	window.parent.ajaxBusyIndicator.dialog.remove();
      }
  });
</script>