...
<c:choose>
    <c:when test="${fieldLayout.dynamicChoice || (fieldLayout.referenceFieldConfigurationAllowed && fieldLayout.multipleSelection) || fieldLayout.languageField || fieldLayout.countryField}">
