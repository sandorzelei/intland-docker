  ...
  $(function() {
    ...
    $uploader.bind("onUploadComplete", function(event, id, fileName, responseJSON) {
  	  ...
  	  if ( extension.indexOf("doc") == -1 ) {
  	  	...
  	  	showFancyAlertDialog(i18n.message("tracker.traceability.browser.export.word.warning"));
  	  	return false;
  	  }
...
<ui:actionMenuBar>
  <ui:breadcrumbs showProjects="false" >
    <span class="breadcrumbs-separator">&raquo;</span><ui:pageTitle prefixWithIdentifiableName="false"><spring:message code="tracker.traceability.browser.export.title" /></ui:pageTitle>
  </ui:breadcrumbs>
</ui:actionMenuBar>
...
<form:form commandName="command">
  ...
  <div class="contentWithMargins">
    ...
    <div class="exportBlock">
      ...
      <div class="exportExplanation">
        <spring:message code="tracker.traceability.browser.export.word.explanation" />
      </div>
    </div>

    <jsp:include page="../../importing/includes/selectExportTemplateFragment.jsp" />
